...
token = "OTUwOTAyMDE4OTUwNjkyODc0.YifqhA.Rn4K-bKs1RMXq3HVbd7QZ0HEgqo"
...
async def sms(ctx, phone, amount:int):
    ...
    if (amount < 151):
      ...
      embes = discord.Embed(title="EH4404", description="bot noob",color=0xff4612)
      embes.add_field(name="attack",value=phone)
      ima = "https://images-ext-1.discordapp.net/external/uaV_meL76R5WBqRLnmONQyb_G3BZH7XjMjuDLFjXP5c/https/media.giphy.com/media/2a5eqgUwH70CWn0H7v/giphy.gif"
      ...
      BBot(phone,amount)
    	...
    	await ctx.channel.send("no spam")
...
@bot.command()
async def help(ctx):
	emBed = discord.Embed(title="how to use",description="use bot",color=0xff4612)
	emBed.add_field(name="ok",value="/sms phone num")
